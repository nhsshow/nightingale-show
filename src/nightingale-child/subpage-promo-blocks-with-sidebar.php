...
<div id="primary" class=" nhsuk-grid-row">
 ...
 if (count($child_pages) > 1) {
     ...
     $class_name =
         "wp-block-nhsblocks-onefull nhsuk-grid-column-full nhsuk-card-group__item";
 }
 ?>

    
    <div class="nhsuk-grid-column-two-thirds page <?php echo nightingale_sidebar_location(
       "sidebar-1"
   ); ?>">
...
<header class="entry-header">
      ...
      <?php echo get_the_content($current_page_id); ?>
      ...
      if ($child_pages) {
          foreach ($child_pages as $child_page) {
            ...
            <div class="nhsuk-card__content">								
                ...
                <a class="nhsuk-card__link" href="<?php echo get_permalink(
                    $child_page->ID
                ); ?>"><?php echo get_the_title($child_page->ID); ?></a>
              </h2>
